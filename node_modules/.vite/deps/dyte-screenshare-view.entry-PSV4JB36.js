...
var DyteScreenshareView = class {
  ...
  render() {
    ...
    } }, h("dyte-icon", { key: "71e4ffe64eb29dcdc7963eb3131234abfecf1792", icon: this.videoExpanded ? this.iconPack.full_screen_minimize : this.iconPack.full_screen_maximize, slot: "start" }), this.videoExpanded ? this.t("screenshare.min_preview") : this.t("screenshare.max_preview")))), h("slot", { key: "a12bec813c857700cf57ba36968526c308be5494" }));
  }
  get host() {
...
export {
  DyteScreenshareView as dyte_screenshare_view
};
//# sourceMappingURL=dyte-screenshare-view.entry-PSV4JB36.js.map
