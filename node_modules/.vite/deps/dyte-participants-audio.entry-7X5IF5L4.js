...
// node_modules/@dytesdk/ui-kit/dist/esm/dyte-participants-audio.entry.js
var DyteAudio = class {
...
var DyteParticipantsAudio = class {
  constructor(hostRef) {
    registerInstance(this, hostRef);
    this.dialogClose = createEvent(this, "dialogClose", 7);
    this.iconPack = defaultIconPack;
    this.t = useLanguage();
    this.preloadedAudioElem = void 0;
  ...
  disconnectedCallback() {
    ...
    if (this.meeting == null)
      return;
    this.audioUpdateListener && this.meeting.participants.joined.removeListener("audioUpdate", this.audioUpdateListener);
    this.screenShareUpdateListener && this.meeting.participants.joined.removeListener("screenShareUpdate", this.screenShareUpdateListener);
    ...
    this.deviceUpdateListener && this.meeting.self.removeListener("deviceUpdate", this.deviceUpdateListener);
    this.stageStatusUpdateListener && ((_a = this.meeting.stage) === null || _a === void 0 ? void 0 : _a.removeListener("stageStatusUpdate", this.stageStatusUpdateListener));
  }
  async setupAudio() {
...
export {
  DyteParticipantsAudio as dyte_participants_audio
};
//# sourceMappingURL=dyte-participants-audio.entry-7X5IF5L4.js.map
