...
// node_modules/@dytesdk/ui-kit/dist/esm/dyte-caption-toggle.entry.js
var dyteCaptionToggleCss = ":host{line-height:initial;font-family:var(--dyte-font-family, sans-serif);font-feature-settings:normal;font-variation-settings:normal}p{margin:var(--dyte-space-0, 0px);padding:var(--dyte-space-0, 0px)}:host{display:block}";
var DyteCaptionToggleStyle0 = dyteCaptionToggleCss;
...
var DyteCaptionToggle = class {
  constructor(hostRef) {
    ...
    this.permissionsUpdateListener = () => {
      var _a;
      this.captionEnabled = (_a = this.meeting.self.permissions.transcriptionEnabled) !== null && _a !== void 0 ? _a : false;
    };
  }
  connectedCallback() {
...
export {
  DyteCaptionToggle as dyte_caption_toggle
};
//# sourceMappingURL=dyte-caption-toggle.entry-XY5E372Y.js.map
