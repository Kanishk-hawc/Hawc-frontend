...
var DyteMicToggle = class {
  ...
  render() {
    ...
    return h(Host, { title: label }, h("dyte-tooltip", { kind: "block", label: tooltipLabel, part: "tooltip" }, h("dyte-controlbar-button", { part: "controlbar-button", icon, label, size: this.size, iconPack: this.iconPack, variant: this.variant, class: classList, onClick: this.toggleMic, showWarning, disabled: disable })));
  }
  static get watchers() {
    return {
...
export {
  DyteMicToggle as dyte_mic_toggle
};
//# sourceMappingURL=dyte-mic-toggle.entry-Y5PRFN3T.js.map
