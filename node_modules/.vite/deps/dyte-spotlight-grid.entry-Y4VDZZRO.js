...
var DyteSpotlightGrid = class {
  ...
  render() {
    ...
    return h(Host, { key: "dbae02de6986b50f91073c0d3e397b0bba1b8dae" }, h("main", { key: "3aab79ea8fb10a418c7e128b7825baf6ef9b9ccf", part: "main" }, h(Render, { key: "a416ee3b0eef6fc99cf04bce32d88a26ee3b50c9", element: "dyte-simple-grid", defaults, props: {
      part: "main-grid",
      participants: this.pinnedParticipants,
      aspectRatio: this.aspectRatio,
      gap: this.gap,
      size: this.getAdaptiveSize(this.pinnedParticipants.length)
    } })), nonPinnedParticipants.length > 0 && h("aside", { key: "266b02b5d0737b31c573028fef1d11b820ac7e39", part: "aside", class: this.gridSize.spotlight ? `grid-width-${this.gridSize.spotlight}` : "grid-width-md" }, h(Render, { key: "283f6a3f085291b1b450f21f39459953a3423915", element: "dyte-simple-grid", defaults, props: {
      part: "aside-grid",
...
export {
  DyteSpotlightGrid as dyte_spotlight_grid
};
//# sourceMappingURL=dyte-spotlight-grid.entry-Y4VDZZRO.js.map
