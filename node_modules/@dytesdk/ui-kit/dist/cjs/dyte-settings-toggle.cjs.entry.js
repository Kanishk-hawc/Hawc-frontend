...
const DyteSettingsToggle = class {
    ...
    render() {
        ...
        return (index$1.h(index$1.Host, { key: 'ff76a80039b161c084cc7c81ecfc9dd35d027c6f', title: text }, index$1.h("dyte-controlbar-button", { key: '893015d704381d3da5d95065b1fbed512c955614', part: "controlbar-button", size: this.size, iconPack: this.iconPack, onClick: () => this.toggleSettings(), icon: this.iconPack.settings, label: text, variant: this.variant })));
    }
};
__decorate([
    index.SyncWithStore()
