...
const DyteNameTag = class {
    ...
    render() {
        ...
        return (index$1.h(index$1.Host, { key: '48c89f27ad186be7c0d06c38c6e640aacd83c822', title: name }, index$1.h("slot", { key: '71ccde71840ab4c6e16b3e7ba52ba341a1c5154e', name: "start" }), index$1.h("span", { key: '30df6dcb1ed2fd4039f6d77d958797af2195af78', class: "name" }, this.formatNameTag(name, isSelf)), index$1.h("slot", { key: '2ad35bca0ed791fcaa1689db6de2293a0a91bb89', name: "end" })));
    }
