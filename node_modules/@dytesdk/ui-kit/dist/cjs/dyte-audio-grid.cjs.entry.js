...
const DyteAudioGrid = class {
    ...
    renderGrid(participants = []) {
        ...
        return participants.map((participant) => {
            return (index$1.h(index$2.Render, { element: "dyte-audio-tile", defaults: defaults, props: {
                    key: participant.id,
                    participant,
                }, childProps: {
                    participant,
    ...
    render() {
        ...
        return (index$1.h(index$1.Host, { key: 'e6ed7876a5948aac4b9596698f2e3047eefc05b5' }, index$1.h("div", { key: '94bb5d98a30cb29a6d949a6ad86cedff15590dc2', class: "content scrollbar" }, index$1.h("div", { key: 'c5521d2415aeb886b178d3792bf50d2942e8293a', class: "stage grid" }, this.renderGrid(onStage)), this.offStageParticipants.length > 0 && (index$1.h("div", { key: '99a43051949d1496fdad0f73b26e6b6caaf14701', class: "waitlist-area" }, index$1.h("div", { key: 'fecc92badc9ce6517a47e98ae3ab28b486a3698a', class: "listening-title" }, this.offStageParticipants.length, " ", this.t('grid.listening')), index$1.h("div", { key: 'eadea3da9dbc7fd01a9333def00649a1ababaf6c', class: "waitlist-grid grid" }, this.renderGrid(this.offStageParticipants))))), index$1.h("slot", { key: '6e05c350e0ad677d3f2f00436ce5c985bf00e498' })));
    }
...
exports.dyte_audio_grid = DyteAudioGrid;
