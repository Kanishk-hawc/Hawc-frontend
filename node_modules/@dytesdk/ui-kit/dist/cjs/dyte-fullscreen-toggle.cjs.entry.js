...
const DyteFullscreenToggle = class {
    ...
    render() {
        ...
        return (index$1.h(index$1.Host, { title: this.t('full_screen') }, index$1.h("dyte-controlbar-button", { size: this.size, iconPack: this.iconPack, onClick: this.toggleFullScreen, icon: this.fullScreenActive
