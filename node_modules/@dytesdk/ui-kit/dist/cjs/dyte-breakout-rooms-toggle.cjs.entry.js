...
const DyteBreakoutRoomsToggle = class {
    ...
    render() {
        if (!this.canToggle)
            return;
        return (index$1.h(index$1.Host, { title: this.t('breakout_rooms') }, index$1.h("dyte-controlbar-button", { part: "controlbar-button", size: this.size, iconPack: this.iconPack, onClick: this.breakoutRoomToggle, icon: this.iconPack.breakout_rooms, label: this.t('breakout_rooms'), variant: this.variant })));
    }
