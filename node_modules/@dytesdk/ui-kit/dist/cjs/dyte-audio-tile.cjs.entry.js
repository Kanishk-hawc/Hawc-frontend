...
const DyteAudioTile = class {
    ...
    render() {
        ...
        return (index$1.h(index$1.Host, { key: '857dc5cefa005a9f429a32b01ef482ad8b2b667f' }, index$1.h("div", { key: 'ea0841398dee55b4cae6fb8a740e0057d1f25071', class: { 'avatar-ctr': true, speaking: this.audioEnabled, [shadowClass]: true } }, index$1.h("dyte-avatar", { key: '84197cb9acc92408a7033c3d0e6e5459a8351e9d', participant: this.participant, size: this.size }, !this.audioEnabled && (index$1.h("div", { key: '9a284bd8863f638321aae3e84a1ac39a73ee9840', class: "mic-icon" }, index$1.h("dyte-icon", { key: '5ea4329213d65c112acf9e323c1c29f61f6f3117', icon: uiStore.defaultIconPack.mic_off }))))), index$1.h("dyte-name-tag", Object.assign({ key: 'd799227e0ad142d6832bd7796ce1f39a4040e19e', variant: "text", participant: this.participant }, defaults)), index$1.h("slot", { key: 'b2b8b06518be41c39ee1d9574192d57993a31bae' })));
    }
