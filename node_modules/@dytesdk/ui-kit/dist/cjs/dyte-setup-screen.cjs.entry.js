...
const DyteSetupScreen = class {
    constructor(hostRef) {
        ...
        this.join = async () => {
            ...
            if (((_a = this.displayName) === null || _a === void 0 ? void 0 : _a.trim()) !== '' && !this.isJoining) {
                ...
                uiStore.gracefulStorage.setItem('dyte-display-name', this.displayName);
                try {
    ...
    render() {
        ...
        return (index$1.h(index$1.Host, { key: 'f805e4673d4958991da4f94cac5baed927b4948d' }, index$1.h("div", { key: 'a024b32ac5ac3f97704d84cae68fe51fed119d11', class: "container" }, index$1.h("div", { key: '548e4bd9a722ea0bb455edbbd058a88ee9ecd0bc', class: 'container-tile' }, index$1.h(index$2.Render, { key: '0b3d3fe938925e43b745ed63ac1ce39e96bbce2e', element: "dyte-participant-tile", defaults: defaults, props: { participant: (_b = this.meeting) === null || _b === void 0 ? void 0 : _b.self, size: 'md', isPreview: true }, childProps: { participant: (_c = this.meeting) === null || _c === void 0 ? void 0 : _c.self, size: 'md' }, deepProps: true }), index$1.h("div", { key: 'eb4f5f3ed6f92930987672db94a1fe277d210680', class: 'media-selectors' }, index$1.h("dyte-microphone-selector", Object.assign({ key: '33cb89903fa15a10cfccc9183ec1093971ce6046' }, defaults, { variant: "inline" })), index$1.h("dyte-camera-selector", Object.assign({ key: '837cc0f33046324273d01937f1db6bbd24c424c3' }, defaults, { variant: "inline" })), index$1.h("dyte-speaker-selector", Object.assign({ key: '242e5749467be68efd7e4be112e65b5cacd0d958' }, defaults, { variant: "inline" })))), index$1.h("div", { key: 'e1de333221602a950e4a44c80850b4b8cad4bc99', class: "metadata" }, index$1.h("div", { key: 'a0a89d93d1a64ff43b6d9a13989c14a9d42740d0', class: "name" }, this.t('setup_screen.join_in_as')), index$1.h("div", { key: '4bf580ad239615e26ac13de446c9117d3398b864', class: "label" }, index$1.h("div", { key: '7bcaea2d3a269b6f2f1ecd323fad3b97f94657cc', class: "name" }, !this.canEditName && string.shorten(this.displayName, 20))), this.canEditName && (index$1.h("input", { key: 'dc99505703b036a9fdde33ff5ebe2da4ac68b1ff', placeholder: this.t('setup_screen.your_name'), value: this.displayName, spellcheck: false, autoFocus: true, ref: (el) => {
                this.inputEl = el;
            }, onInput: (e) => {
            ...
            } })), index$1.h("dyte-button", { key: 'ace3c4221055be90c22576b26ac036b188712583', size: "lg", kind: "wide", onClick: this.join, disabled: disabled }, this.isJoining ? index$1.h("dyte-spinner", { iconPack: this.iconPack }) : this.t('join')), this.connectionState !== 'connected' && (index$1.h("div", { key: '6210c8592a6bb39479c38baa6afdb65457456eaa', class: "no-network-badge" }, index$1.h("dyte-icon", { key: 'bc903acf0707943acb581eb4d76c85d2b55bdd74', size: "md", variant: "danger", icon: this.iconPack.disconnected }), this.connectionState === 'failed'
