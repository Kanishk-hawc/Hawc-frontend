...
const DyteRecordingIndicator = class {
    ...
    render() {
        return (index$1.h(index$1.Host, { key: 'b08cb38ca93d2db33679ac266e18063c4a2756cf' }, this.isRecording && (index$1.h("div", { key: '5ba29ae19d2b338f32ec07ec2ef2662c61a7b5f9', class: "indicator", "aria-label": this.t('recording.indicator'), part: "indicator" }, index$1.h("dyte-icon", { key: 'd2309f97e7e6f8d3f6cb62e4766b69993e32d803', icon: this.iconPack.recording, "aria-hidden": true, tabIndex: -1, part: "icon" }), index$1.h("span", { key: 'e8ddc6b7188df3f44ae0e6f3be0cdf0176cc8ebd' }, this.t('recording.label'))))));
    }
