...
const DyteParticipantsAudio = class {
    ...
    render() {
        return (index$1.h(index$1.Host, { key: '8f75e172807ecedd630de70b5cc3e8c73aad09de' }, this.showPlayDialog && (index$1.h("dyte-dialog", { key: '4770efe5ed393e2033706e983996a2b7f822feac', open: true, onDyteDialogClose: this.onDyteDialogClose, hideCloseButton: true, disableEscapeKey: true, iconPack: this.iconPack, t: this.t }, index$1.h("div", { key: '5c1cb440b28b8a7a3e655056a3495f1d10c7168e', class: "modal" }, index$1.h("h3", { key: 'c3426d43cb93374db943952d7e21ecc7ed49c6ad' }, this.t('audio_playback.title')), index$1.h("p", { key: '46e1b0443fec08430c1d08556a528e2de7419708' }, this.t('audio_playback.description')), index$1.h("dyte-button", { key: '99173304cfa04af361162d78993c0ccb06de3400', kind: "wide", onClick: () => {
                this.audio.play();
                this.onDyteDialogClose();
