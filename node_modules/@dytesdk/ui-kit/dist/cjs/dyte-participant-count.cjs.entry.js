...
const DyteParticipantCount = class {
    ...
    render() {
        if (this.isViewer)
            return null;
        return (index$1.h(index$1.Host, { tabIndex: 0, role: "log", "aria-label": `${this.participantCount} ${this.t('participants')}` }, index$1.h("dyte-icon", { icon: this.iconPack.people, tabIndex: -1, "aria-hidden": true, part: "icon" }), this.participantCount));
    }
