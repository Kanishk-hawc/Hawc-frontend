...
const DytePollsToggle = class {
    ...
    render() {
        ...
        return (index$1.h(index$1.Host, { title: text }, this.unreadPollsCount !== 0 && !this.pollsActive && (index$1.h("div", { class: "unread-count", part: "unread-count" }, index$1.h("span", null, this.unreadPollsCount <= 100 ? this.unreadPollsCount : '99+'))), index$1.h("dyte-controlbar-button", { part: "controlbar-button", size: this.size, iconPack: this.iconPack, class: { active: this.pollsActive }, onClick: () => this.togglePollsTab(), icon: this.iconPack.poll, label: text, variant: this.variant })));
    }
...
exports.dyte_polls_toggle = DytePollsToggle;
