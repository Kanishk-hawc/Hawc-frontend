...
const DyteChannelSelectorUi = class {
    constructor(hostRef) {
        ...
        this.renderChannelDisplayPic = (channel) => {
            ...
            if (channel.isDirectMessage || hasDisplayPic) {
                return (index$1.h("div", { class: "channel-display" }, index$1.h("dyte-avatar", { participant: {
                        name: channel.displayName,
                        picture: channel.displayPictureUrl,
                    } })));
            }
            else {
                return (index$1.h("div", { class: "channel-display" }, index$1.h("dyte-icon", { icon: this.iconPack.people, slot: "start" })));
            }
        };
    ...
    render() {
        return (index$1.h(index$1.Host, { key: '27beb64372e71cdbb45b0bc42e834a063e266cab' }, index$1.h("div", { key: 'f3cb26446d420df375d787366b02d1013ecad4f0', class: "container", ref: (el) => (this.$el = el) }, this.isHidden && (index$1.h("dyte-button", { key: 'be5dbd465d468c14be597c0ceda26f0cf9075fe5', kind: "icon", variant: "ghost", size: "md", onClick: this.onRevealClicked, class: "sidebar-btn" }, index$1.h("dyte-icon", { key: '9e3d65b701a7741226c8f9acbda523c584f7c7b7', icon: this.isHidden ? this.iconPack.chevron_left : this.iconPack.dismiss }))), index$1.h("slot", { key: '8d358b9e23259c5ebf45898c0938d5cbfbcd7b56', name: "header" }), index$1.h("div", { key: '35f4e5036e536020337db098c7769d414215bf96', class: "search-wrapper" }, index$1.h("div", { key: 'd5663429fbf31cf231204c5cde31e1f9a0e9afe0', class: "search" }, index$1.h("input", { key: '9c156d36dc6501de62f7ba622a20b7ce407a2ede', type: "search", autocomplete: "off", placeholder: this.t('chat.search_conversations'), onInput: this.onSearchInput }), index$1.h("dyte-icon", { key: '498ecabfbce5b0725618e1112dc1dcb7eca2dd58', icon: this.iconPack.search, class: "search-icon" }))), index$1.h("div", { key: 'c33ba36c7e50fda20ef39ee12725e4d64f8cb520', class: "channel-container scrollbar", role: "list" }, this.channels
        ...
        }))), !this.isHidden && (index$1.h("div", { key: 'cc51252e87759bb0fa10de6bae2b3b9af783693f', class: "overlay-container" }, index$1.h("dyte-button", { key: '5d66dc9ddbfa169f2c3c077d919d0fcaf4c6eeca', kind: "icon", variant: "ghost", size: "md", onClick: this.onRevealClicked, class: "sidebar-btn" }, index$1.h("dyte-icon", { key: 'd81b19a9e5af1a62df723cd32d27779c59dd3ded', icon: this.isHidden ? this.iconPack.chevron_left : this.iconPack.dismiss }))))));
    }
};
__decorate([
    index.SyncWithStore()
...
exports.dyte_channel_selector_ui = DyteChannelSelectorUi;
