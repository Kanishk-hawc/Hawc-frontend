...
const DyteRecordingToggle = class {
    ...
    render() {
        if (!this.canRecord)
            return;
        return (index$1.h(index$1.Host, { title: this.t(this.recordingState === 'RECORDING' ? 'recording.stop' : 'recording.idle') }, index$1.h("dyte-controlbar-button", { part: "controlbar-button", size: this.size, iconPack: this.iconPack, onClick: this.toggleRecording, icon: this.getIcon(), isLoading: this.isLoading(), label: this.t(this.getLabel()), variant: this.variant, disabled: this.disabled })));
    }
...
exports.dyte_recording_toggle = DyteRecordingToggle;
