...
const DyteInformationTooltip = class {
    ...
    render() {
        return (index$1.h(index$1.Host, { key: '1822149a5a3207123a195788c5bd496a308cb5f0' }, index$1.h("div", { key: '75b5ae46629ab8950e071eb3b040530ae590a687', class: "tooltip-container" }, index$1.h("dyte-icon", { key: '88335152fe1f6c73e324873fb652a759017c36a1', icon: this.iconPack.info, size: "sm" }), index$1.h("div", { key: '310bb9aa766c63e64d6719bd1df11cdc1a4aa079', class: "tooltip" }, index$1.h("slot", { key: 'da533663227141d5a6d172b5f1e75698d3f037be', name: "tootlip-text" })))));
    }
};
__decorate([
    index.SyncWithStore()
