...
const DyteControlbarButton = class {
    ...
    render() {
        return (index$1.h(index$1.Host, { key: '106768342cdfefe6b850dce971b861b9522eccd8' }, index$1.h("button", { key: '51da1cbac6b462605d2a3746fb733072d3ff3a9a', "aria-label": this.label, part: "button" }, this.isLoading ? (index$1.h("dyte-spinner", { id: "icon", part: "spinner", iconPack: this.iconPack })) : (index$1.h("dyte-icon", { id: "icon", icon: this.icon, tabIndex: -1, "aria-hidden": true, part: "icon" })), index$1.h("span", { key: 'cd06da56f4a0ffa201463977f5fbb3d76434442a', class: "label", part: "label" }, this.label), this.showWarning && (index$1.h("dyte-icon", { key: '36b6f5927ed22c3bff973e546aca5158790c2ef3', id: "warning-indicator", icon: this.iconPack.warning, part: "warning-indicator" })))));
    }
};
__decorate([
    index.SyncWithStore()
