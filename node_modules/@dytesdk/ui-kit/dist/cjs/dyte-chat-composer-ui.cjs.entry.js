...
const DyteChatComposerUi = class {
    constructor(hostRef) {
        ...
        this.onNewMessage = index$1.createEvent(this, "dyteNewMessage", 7);
        this.onEditMessage = index$1.createEvent(this, "dyteEditMessage", 7);
        this.onEditCancelled = index$1.createEvent(this, "dyteEditCancelled", 7);
        ...
        this.renderSuggestedReplies = () => {
            ...
            if (this.prefill.suggestedReplies.length === 0)
                return;
            return (index$1.h("ul", { class: "suggested-replies scrollbar" }, this.prefill.suggestedReplies.map((reply) => (index$1.h("dyte-tooltip", { label: this.t('chat.click_to_send') }, index$1.h("li", { onClick: () => this.onNewMessage.emit({ type: 'text', message: reply }) }, reply))))));
        };
        this.renderMenu = () => {
    ...
    renderFilePreview() {
        if (typeof this.filePreview !== 'string')
            return;
        return (index$1.h("div", { class: "preview-overlay" }, index$1.h("div", { class: "file-preview" }, index$1.h("dyte-tooltip", { label: this.t('chat.cancel_upload') }, index$1.h("dyte-button", { variant: "secondary", kind: "icon", onClick: this.cleanUpFileUpload }, index$1.h("dyte-icon", { icon: this.iconPack.dismiss }))), this.fileToUpload.type === 'image' ? (index$1.h("img", { class: "preview-image", src: this.filePreview })) : (index$1.h("div", { class: "preview-file" }, index$1.h("span", null, this.filePreview))))));
    }
    render() {
        var _a;
        let defaultValue = '';
        ...
        return (index$1.h(index$1.Host, { key: 'bd9e183a8595fdf13f53dfe74243fc58b889b490' }, this.canSendTextMessage && this.emojiPickerActive && (index$1.h("dyte-emoji-picker", { key: '63cbab4694b7640574190ced33fc146742dabd16', part: "emoji-picker", onPickerClose: () => {
                this.emojiPickerActive = false;
            }, onDyteEmojiClicked: (e) => {
                this.$textArea.value += e.detail;
                this.$textArea.focus();
            }, t: this.t })), this.renderSuggestedReplies(), index$1.h("slot", { key: '3c12d633831662382c5ee01830b6a1dccffa1c36', name: "chat-addon" }), index$1.h("slot", { key: 'e94a874a6afd03896c905af9974c8cc8de662d7a', name: "quote-block" }), index$1.h("div", { key: '5a9c021aa2501c6da3d25e75b72338aea15a635c', class: "chat-input", part: "chat-input" }, this.renderMenu(), this.canSendTextMessage && (index$1.h("textarea", { key: 'bc8057712688cdb12f40fa62d1dca57797785b75', class: "scrollbar", part: "textarea", ref: this.initializeTextField, autoFocus: true, placeholder: this.fileToUpload ? '' : this.t('chat.message_placeholder'), value: defaultValue, onPaste: this.onPaste, maxLength: chat.MAX_TEXT_LENGTH, onKeyDown: this.handleKeyDown, onKeyUp: this.handleKeyUp, onInput: (e) => {
                uiStore.gracefulStorage.setItem(this.storageKey, e.target.value);
            }, disabled: !!this.filePreview })), index$1.h("div", { key: '6df2b595eed0375f53bed5d56bdcc6c0493a8247', class: "chat-buttons", part: "chat-buttons" }, index$1.h("div", { key: '021c7d3b3901080792144bf5f76eab855c11b4e4', class: "left", part: "chat-buttons-left" }, !this.prefill.editMessage &&
            this.canSendFiles && [
            index$1.h("dyte-tooltip", { key: 'c11d06e54dcfde7fd035a4c3037046f0364a92ba', label: this.t('chat.send_file') }, index$1.h("dyte-button", { key: '2124e7ca46e80b74fc10a6698471671360285bc0', variant: "ghost", kind: "icon", onClick: () => this.uploadFile('file'), title: this.t('chat.send_file') }, index$1.h("dyte-icon", { key: '511036aad6e7b7098a281ef7e365ad1ba1a6e25f', icon: this.iconPack.attach }))),
            index$1.h("dyte-tooltip", { key: '77777a43eae025a8b1e40d1945f8cec0445992be', label: this.t('chat.send_img') }, index$1.h("dyte-button", { key: '51bbef7f90a068397eab5affeec9877f8d9be929', variant: "ghost", kind: "icon", onClick: () => this.uploadFile('image'), title: this.t('chat.send_img') }, index$1.h("dyte-icon", { key: '98a2c7f941afe3bcb06cc18984978311f9c0e501', icon: this.iconPack.image }))),
        ], !this.prefill.editMessage && this.canSendTextMessage && !this.disableEmojiPicker && (index$1.h("dyte-tooltip", { key: 'a614a1ca853e2e2e7390cf74321f70881cde38a9', label: this.t('chat.send_emoji') }, index$1.h("dyte-button", { key: 'ae859f19d1e8372723409dc0530ed5bcfc01c619', variant: "ghost", kind: "icon", class: { active: this.emojiPickerActive }, title: this.t('chat.send_emoji'), onClick: () => {
                this.emojiPickerActive = !this.emojiPickerActive;
            } }, index$1.h("dyte-icon", { key: '92e8add087597deca28e864fffad34f521203f01', icon: this.iconPack.emoji_multiple }))))), !!this.filePreview && this.renderFilePreview(), this.canSendTextMessage && (index$1.h("div", { key: '3a1dd50dd4f77dfdce4ecef6cbeeb7cd7330044c', class: "right", part: "chat-buttons-right" }, !this.prefill.editMessage && (index$1.h("dyte-tooltip", { key: '47afdb3c09f71c39e0f059f6f19f367aa3c0164b', variant: "primary", label: this.t('chat.send_msg'), delay: 2000 }, index$1.h("dyte-button", { key: '1a7646cee202fa4be64de7bb0afc8b58dd750919', kind: "icon", onClick: () => this.handleSendMessage(), title: this.t('chat.send_msg') }, index$1.h("dyte-icon", { key: 'ebc857dc0e41c20f8bc73d3123f9b3cf8c752aa6', icon: this.iconPack.send })))), this.prefill.editMessage && (index$1.h("div", { key: '20ed1557de83b2bbc3167ee58a2535f9d53dd5d2', class: "edit-buttons" }, index$1.h("dyte-tooltip", { key: '542bc4c98d2411579913c50dae2fe3ddf26858c0', variant: "secondary", label: this.t('cancel'), delay: 2000 }, index$1.h("dyte-button", { key: 'ff5bcf87c4cf6a13385f7314744f9dc39ead0b3d', kind: "icon", variant: "secondary", onClick: () => this.handleEditCancel(), title: this.t('cancel') }, index$1.h("dyte-icon", { key: '5f514ddf6986d2fe4bfe9641c0aa0c8a834cfae8', icon: this.iconPack.dismiss }))), index$1.h("dyte-tooltip", { key: 'f0ebc5ea3f5801377ded5745a7bf83cd369a7fe4', variant: "primary", label: this.t('chat.update_msg'), delay: 2000 }, index$1.h("dyte-button", { key: '34e8521c0a11747adddedf555dcceba8b7db2a27', kind: "icon", onClick: () => this.handleEditMessage(), title: this.t('chat.send_msg') }, index$1.h("dyte-icon", { key: '8082c8dcb7a670889bf07a2811baa432c85ebf53', icon: this.iconPack.checkmark })))))))))));
    }
