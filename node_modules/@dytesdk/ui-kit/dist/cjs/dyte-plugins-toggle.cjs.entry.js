...
const DytePluginsToggle = class {
    ...
    render() {
        ...
        return (index$1.h(index$1.Host, { title: text }, index$1.h("dyte-controlbar-button", { part: "controlbar-button", size: this.size, iconPack: this.iconPack, class: { active: this.pluginsActive }, onClick: () => this.togglePlugins(), icon: this.iconPack.rocket, label: text, variant: this.variant })));
    }
...
exports.dyte_plugins_toggle = DytePluginsToggle;
