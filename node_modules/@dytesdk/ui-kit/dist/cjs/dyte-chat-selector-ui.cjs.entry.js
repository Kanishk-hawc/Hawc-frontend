...
const DyteChatSelectorUi = class {
    constructor(hostRef) {
        ...
        this.groupChanged = index$1.createEvent(this, "dyteChatGroupChanged", 7);
        /** Unread counts */
        this.unreadCounts = {};
        /** Participants */
        this.groups = [];
    ...
    render() {
        ...
        return (index$1.h(index$1.Host, null, index$1.h("div", { class: "chat-scope-selector" }, this.showParticipantsPanel && (index$1.h("div", { class: "participants-container" }, index$1.h("div", { class: "search", part: "search" }, index$1.h("dyte-icon", { icon: this.iconPack.search, part: "search-icon" }), index$1.h("input", { type: "search", autocomplete: "off", placeholder: this.t('search'), value: this.query, onInput: (e) => {
                this.query = e.target.value;
            }, part: "search-input" })), index$1.h("ul", { class: "scope-list scrollbar" }, this.query === '' && (index$1.h("li", { class: "scope scope-special", onClick: () => this.onScopeClick('everyone') }, index$1.h("div", { class: "everyone-icon" }, index$1.h("dyte-icon", { icon: this.iconPack.participants })), this.t('everyone'), this.unreadCounts['everyone'] > 0 && (index$1.h("div", { class: "unread-count", part: "unread-count" }, index$1.h("span", null, this.unreadCounts['everyone']))))), this.getGroups().map((group) => {
        ...
        })))), index$1.h("button", { onClick: () => this.toggleParticipants() }, index$1.h("span", null, `${this.t('to')} ${this.getName()}`, '  ', unreadCountTotal > 0 && (index$1.h("div", { class: "unread-count selector" }, index$1.h("span", null, unreadCountTotal)))), index$1.h("dyte-icon", { icon: this.showParticipantsPanel ? this.iconPack.chevron_up : this.iconPack.chevron_down })))));
    }
};
__decorate([
    index.SyncWithStore()
