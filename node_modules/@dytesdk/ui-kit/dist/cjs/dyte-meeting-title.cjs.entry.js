...
const DyteMeetingTitle = class {
    ...
    render() {
        ...
        if (title == null)
            return null;
        return (index$1.h(index$1.Host, { tabIndex: 0, role: "banner", "aria-label": title }, index$1.h("dyte-tooltip", { label: title, part: "tooltip" }, index$1.h("div", { class: "title", part: "title" }, title))));
    }
};
__decorate([
    index.SyncWithStore()
...
exports.dyte_meeting_title = DyteMeetingTitle;
