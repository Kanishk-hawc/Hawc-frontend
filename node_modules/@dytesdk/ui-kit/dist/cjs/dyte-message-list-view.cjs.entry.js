...
const DyteMessageListView = class {
    ...
    render() {
        return (index$1.h("div", { key: '02660589d69e1290972669e40d032341aef9265f', class: "scrollbar content-wrapper", ref: (el) => (this.$listRef = el), onScroll: this.handleScroll }, index$1.h("div", { key: '7e0741ead290cf3050001dd3990a87fa41bd00db', class: "scroller" }, index$1.h("div", { key: '18a4d58c6ff888d1e11757eb4f4dd94d7f36ad42', style: {
                height: `${this.totalHeight}px`,
            } }), index$1.h("div", { key: '44db5507f72fdd916e27dd1100dd34997b2c9e18', class: "smallest-dom-element", id: "list-end", ref: (el) => (this.$listEndRef = el) })), index$1.h("div", { key: '64cb94699d06d72bf1559fa0d2c7dfff517d3c36', class: "content", style: {
                transform: `translateY(${this.getRangeSize(0, this.range.start)}px)`,
            } }, this.isFetching && (index$1.h("div", { key: 'f55148d694e0e323882d9e2521cd9b5ef6779d3a', class: "loader" }, index$1.h("dyte-spinner", { key: '84978cbf9a49e1552bdf39a5969ccf7bb152c475', size: "md" }))), this.getVisibleItems().map((msg, index) => (index$1.h("div", { key: msg.id, ref: (el) => this.rendererInternal(el, msg, index) }))))));
    }
