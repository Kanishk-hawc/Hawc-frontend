...
const DyteChatToggle = class {
    ...
    render() {
        ...
        return (index$1.h(index$1.Host, { title: this.t('chat') }, uiStore.usePaginatedChat(this.meeting)
            ...
            : this.unreadMessageCount !== 0 &&
                !this.chatActive && (index$1.h("div", { class: "unread-count", part: "unread-count" }, index$1.h("span", null, this.unreadMessageCount <= 100 ? this.unreadMessageCount : '99+'))), index$1.h("dyte-controlbar-button", { part: "controlbar-button", size: this.size, iconPack: this.iconPack, class: { active: this.chatActive }, onClick: this.toggleChat, icon: this.iconPack.chat, label: this.t('chat'), variant: this.variant })));
    }
