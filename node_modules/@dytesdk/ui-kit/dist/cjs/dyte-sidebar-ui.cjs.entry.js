...
const DyteSidebarUi = class {
    ...
    render() {
        ...
        return (index$1.h(index$1.Host, { key: '3cc819dfdd7a7afb27c4d5c0caad190e744416e5', class: this.view }, !this.hideCloseAction && (index$1.h("dyte-button", { key: '49f610426277037837150d9b5f732c86a8a008df', variant: "ghost", kind: "icon", class: "close", onClick: this.onClose, "aria-label": this.t('close') }, index$1.h("dyte-icon", { key: '6c5f8cbb8d2e4b12e2e924aa7881811a5c6afa32', icon: this.iconPack.dismiss }))), activeTab && !this.hideHeader && (index$1.h("header", { key: 'f55415f94849e74606dd21973822dd9495d01327', class: "main-header" }, index$1.h("h3", { key: 'f240ff5fa5fe71e83d1c43ab705ec75903720c89' }, activeTab.name), index$1.h("slot", { key: 'f4d05f1edd487c5d1c731914b94dae796cf1daf6', name: "pinned-state" }))), isFullScreen && (index$1.h("header", { key: '9a782da10bf0f63523ef96a5bd98708853489beb', class: "mobile-tabs" }, this.tabs.map((tab) => (index$1.h("button", { onClick: () => {
                this.tabChange.emit(tab.id);
            }, class: {
                active: this.currentTab === tab.id,
            } }, tab.name))))), index$1.h("slot", { key: '2656a53d4f0ce0c8b4001292b667e5efa2adcc9d', name: this.currentTab })));
    }
};
__decorate([
    index.SyncWithStore()
...
exports.dyte_sidebar_ui = DyteSidebarUi;
