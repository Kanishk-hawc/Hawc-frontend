...
:host([size='sm']) aside button.hidden {
      display: none;
    }
...
aside button:host([size='sm']) aside.hide {
    display: none;
  }

:host([size='sm']) aside button:host([size='sm']) aside.hide {
      display: none;
    }
...
aside button:host([size='sm']) main {
    display: none;
  }

:host([size='sm']) aside button:host([size='sm']) main {
      display: none;
    }
