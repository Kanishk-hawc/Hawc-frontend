...
import { defaultConfig, generateConfig, provideDyteDesignSystem, } from "../../exports";
...
export class DyteUiProvider {
    ...
    static get is() { return "dyte-ui-provider"; }
    static get originalStyleUrls() {
        return {
            "$": ["dyte-ui-provider.css"]
        };
    }
        ...
        return {
            ...
            "noRenderUntilMeeting": {
                ...
                "docs": {
                    ...
                    "text": "Do not render children until meeting is initialized"
                },
                "getter": false,
                "setter": false,
                "attribute": "no-render-until-meeting",
                "reflect": false,
                "defaultValue": "false"
            }
        };
