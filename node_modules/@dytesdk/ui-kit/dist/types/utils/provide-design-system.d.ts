 ...
 */
export declare const provideDyteDesignSystem: (el: HTMLElement, { spacingBase, borderRadius, borderWidth, colors, fontFamily, googleFont, theme, tokenPrefix, }: Omit<DesignTokens, "logo">) => void;
