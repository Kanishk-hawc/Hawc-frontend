import type { DyteThemePreset } from '@dytesdk/web-core';
 ...
 * @returns
 */
export declare const generateConfig: (oldConfig: Partial<DyteThemePreset>, meeting: Meeting, toExtend?: UIConfig, options?: ConfigOptions) => {
    config: UIConfig;
    data: ConfigData;
};
export {};
