...
const DyteDebuggerAudio = /*@__PURE__*/ proxyCustomElement(class DyteDebuggerAudio extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return DyteDebuggerAudioStyle0; }
}, [1, "dyte-debugger-audio", {
        "meeting": [16],
        "states": [16],
        "size": [513],
        "iconPack": [16],
...
function defineCustomElement() {
    ...
    const components = ["dyte-debugger-audio"];
