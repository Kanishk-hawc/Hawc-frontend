...
import { a as defaultIconPack, c as useLanguage, j as resetRoomCount, B as BreakoutRoomsManager, p as participantIdentifier } from './p-dce5d30e.js';
import { S as SyncWithStore } from './p-9ae68517.js';
import { d as defineCustomElement$8 } from './p-b503759c.js';
import { d as defineCustomElement$7 } from './p-a9bd9d4b.js';
import { d as defineCustomElement$6 } from './p-0ac95ccf.js';
import { d as defineCustomElement$5 } from './p-e7892c80.js';
import { d as defineCustomElement$4 } from './p-a01c5f12.js';
...
const MIN_ROOMS = 1;
const DyteBreakoutRoomsManager = /*@__PURE__*/ proxyCustomElement(class DyteBreakoutRoomsManager extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return DyteBreakoutRoomsManagerStyle0; }
    ...
    components.forEach(tagName => { switch (tagName) {
        case "dyte-breakout-rooms-manager":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DyteBreakoutRoomsManager);
            }
            break;
        case "dyte-avatar":
            if (!customElements.get(tagName)) {
...
export { DyteBreakoutRoomsManager as D, defineCustomElement as d };
