...
const DyteDebuggerVideo = /*@__PURE__*/ proxyCustomElement(class DyteDebuggerVideo extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return DyteDebuggerVideoStyle0; }
...
function defineCustomElement() {
    ...
    const components = ["dyte-debugger-video"];
    components.forEach(tagName => { switch (tagName) {
        case "dyte-debugger-video":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DyteDebuggerVideo);
            }
            break;
    } });
}
...
export { DyteDebuggerVideo as D, defineCustomElement as d };
