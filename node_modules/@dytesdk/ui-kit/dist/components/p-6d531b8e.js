...
const DyteDebuggerScreenShare = /*@__PURE__*/ proxyCustomElement(class DyteDebuggerScreenShare extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return DyteDebuggerScreenshareStyle0; }
...
function defineCustomElement() {
    ...
    const components = ["dyte-debugger-screenshare"];
    components.forEach(tagName => { switch (tagName) {
        case "dyte-debugger-screenshare":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DyteDebuggerScreenShare);
            }
            break;
    } });
}
...
export { DyteDebuggerScreenShare as D, defineCustomElement as d };
