...
const DyteParticipantSetup$1 = /*@__PURE__*/ proxyCustomElement(class DyteParticipantSetup extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return DyteParticipantSetupStyle0; }
}, [1, "dyte-participant-setup", {
...
__decorate([
    SyncWithStore()
], DyteParticipantSetup$1.prototype, "states", void 0);
__decorate([
    SyncWithStore()
], DyteParticipantSetup$1.prototype, "size", void 0);
__decorate([
    SyncWithStore()
], DyteParticipantSetup$1.prototype, "iconPack", void 0);
__decorate([
    SyncWithStore()
], DyteParticipantSetup$1.prototype, "t", void 0);
function defineCustomElement$1() {
    if (typeof customElements === "undefined") {
        return;
    }
    const components = ["dyte-participant-setup"];
    components.forEach(tagName => { switch (tagName) {
        case "dyte-participant-setup":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DyteParticipantSetup$1);
            }
            break;
    } });
}
...
const DyteParticipantSetup = DyteParticipantSetup$1;
const defineCustomElement = defineCustomElement$1;

export { DyteParticipantSetup, defineCustomElement };
