import { p as proxyCustomElement, H, d as createEvent, w as writeTask, f as forceUpdate, h, e as Host } from './p-1d5392d7.js';
...
const DyteChannelCreator = /*@__PURE__*/ proxyCustomElement(class DyteChannelCreator extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    get $el() { return this; }
    static get style() { return DyteChannelCreatorStyle0; }
    ...
    components.forEach(tagName => { switch (tagName) {
        case "dyte-channel-creator":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DyteChannelCreator);
            }
            break;
        case "dyte-avatar":
            if (!customElements.get(tagName)) {
...
export { DyteChannelCreator as D, defineCustomElement as d };
