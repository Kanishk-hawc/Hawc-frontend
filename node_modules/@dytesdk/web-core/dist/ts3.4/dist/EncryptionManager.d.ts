...
declare class DyteMeta extends DyteTypedEventEmitter<MetaEvents> {
...
declare class DyteMap<T extends (EventMap & WildCardEvent<T>), U extends {
    ...
    constructor(options: DyteMapEvents<V>, logger?: DyteLogger);
...
declare class DyteParticipantMap<T extends Pick<DyteParticipant, 'id' | keyof DyteTypedEventEmitter<ParticipantEvents>> = DyteParticipant> extends DyteMap<ParticipantEvents, T, ParticipantMapEvents> {
    constructor(logger: DyteLogger$1, options?: DyteMapEvents<ParticipantMapEvents>);
...
declare class DyteParticipants$1 extends DyteTypedEventEmitter<ParticipantsEvents> {
    readonly waitlisted: Readonly<DyteParticipantMap<Pick<DyteParticipant, Exclude<keyof DyteParticipant, 'audioTrack' | 'videoTrack' | 'screenShareTracks'>>>>;
    readonly joined: Readonly<DyteParticipantMap>;
    readonly active: Readonly<DyteParticipantMap>;
    readonly videoSubscribed: Readonly<DyteParticipantMap>;
    readonly audioSubscribed: Readonly<DyteParticipantMap>;
...
declare class DyteThemePreset {
    private constructor();
    static fromResponse(preset: PresetV2CamelCased): DyteThemePreset;
    static default(): DyteThemePreset;
    static init(preset?: PresetV2CamelCased, useDefault?: boolean): DyteThemePreset;
...
declare class DytePermissionsPreset extends DyteTypedEventEmitter<PermissionEvents> {
    private constructor();
    private setupEvents;
    static fromResponse(response: PresetPermissions, viewType: ViewType, context: Context<DyteContextState>): DytePermissionsPreset;
    static default(context: Context<DyteContextState>, viewType: ViewType): DytePermissionsPreset;
    static init(context: Context<DyteContextState>, viewType: ViewType, response?: PresetPermissions): DytePermissionsPreset;
...
declare class SelfController {
    ...
    private constructor();
    static init(context: Context<DyteContextState>, roomSocketHandler: RoomSocketHandler, participant: UserDetailsResponseV2['participant'], permissions: DytePermissionsPreset, theme: DyteThemePreset): Promise<SelfController>;
...
declare class DyteLivestream extends DyteTypedEventEmitter<LivestreamEvents> {
...
declare class DyteChat extends DyteTypedEventEmitter<ChatEvents> {
    messages: Message[];
...
declare class DytePolls extends DyteTypedEventEmitter<PollsEvents> {
    items: Poll[];
...
type PluginMapEvents = {
    ['pluginAdded']: (plugin: DytePlugin) => void;
    ['pluginDeleted']: (plugin: DytePlugin) => void;
};
type PluginEvents$1 = {
    ['stateUpdate']: (payload: {
        active: boolean;
...
declare class DytePluginMap<T extends DytePlugin = DytePlugin> extends DyteMap<PluginEvents$1, T, PluginMapEvents> {
    constructor(logger: DyteLogger);
    add(plugin: T, emitEvent?: boolean): this;
    delete(pluginId: string, emitEvent?: boolean, removeListeners?: boolean): boolean;
}
declare class DytePlugins {
    readonly all: DytePluginMap;
    readonly active: DytePluginMap;
...
declare class DyteRecording extends DyteTypedEventEmitter<RecordingEvents> {
...
declare class DyteInternals {
    ...
    constructor(logger: DyteLogger, features: DyteFeatures, callStats: InhouseCallStats);
    static init(context: Context<DyteContextState>): DyteInternals;
}
type StoreData = {
    [type: string]: any;
};
declare class DyteStore {
    name: string;
    rateLimitConfig: {
        maxInvocations: number;
        period: number;
...
declare class DyteConnectedMeetings extends DyteTypedEventEmitter<ConnectedMeetingsEvents> {
    constructor(context: Context<DyteContextState>);
    meetings: ConnectedMeeting[];
    parentMeeting: ConnectedMeeting;
...
declare class DyteError extends Error {
    ...
    constructor(message: string, code?: keyof typeof ERROR_CODES, logger?: DyteLogger | undefined, log?: boolean);
}
type EventMap$1 = {
    [key: string]: (...args: any[]) => void;
};
interface TypedEventEmitter<Events extends EventMap$1> {
...
type TypedEvents = {
    ...
    [SessionEvents.PEER_JOINED_INTERNAL]: (p: DyteParticipant) => void;
...
declare class DyteSelf$1 extends DyteSelfMedia {
    ...
    private constructor();
    static __init__(context: Context<DyteContextState>, details: UserDetailsResponse, permissions: DytePermissionsPreset, theme: DyteThemePreset, presetName: string, skipAwaits?: boolean): Promise<DyteSelf$1>;
    cleanupEvents(): void;
    private setupEvents;
    readonly permissions: DytePermissionsPreset;
    readonly config: DyteThemePreset;
    readonly roomJoined: boolean;
...
declare class DytePlugin extends DyteEventEmitter<PluginEvents> {
    ...
    enabledBy: string;
    readonly telemetry: DyteTelemetry;
    constructor(context: Context<DyteContextState>, { baseURL, createdAt, description, id, name, organizationId, picture, private: isPrivate, published, staggered, tags, type, updatedAt, }: DytePluginResponse, pluginSocketHandler: PluginSocketHandler, self: DyteSelf$1, participants: DyteParticipants$1, chat: Readonly<DyteChat>, meetingTitle: string);
...
declare class DyteClient {
    ...
    static initMedia(options?: {
        ...
        audio?: boolean;
        constraints?: MediaConstraints;
    }, skipAwaits?: boolean, cachedUserDetails?: CachedUserDetails): DyteSelfMedia;
    ...
    readonly meta: Readonly<DyteMeta>;
    readonly ai: Readonly<DyteAi>;
    readonly plugins: Readonly<DytePlugins>;
    readonly chat: Readonly<DyteChat>;
    readonly polls: Readonly<DytePolls>;
    readonly connectedMeetings: Readonly<DyteConnectedMeetings>;
    readonly recording: Readonly<DyteRecording>;
    readonly livestream: Readonly<DyteLivestream>;
...
declare class DyteParticipant extends DyteTypedEventEmitter<ParticipantEvents> {
    id: string;
    userId: string;
    name: string;
    picture: string;
...
declare class DyteTypedEventEmitter<Events extends EventMap & WildCardEvent<Events>> extends EventEmitter$1 {
    logger: DyteLogger | undefined;
    constructor(logger: DyteLogger);
...
declare class BaseKeyProvider extends DyteEventEmitter<KeyProviderEvents> {
    private keyInfoMap;
    private options;
...
declare class DyteE2EEManager extends DyteEventEmitter<EncryptionEvents> {
    ...
    init(logger: DyteLogger$1, peerSessionStore: any): void;
    setup(): void;
    private onWorkerMessage;
}
export { DyteE2EEManager as default };
