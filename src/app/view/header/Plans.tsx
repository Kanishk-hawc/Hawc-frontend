...
export default function Plans() {
  ...
  // Function to handle plan selection - this is where we'll add the initial selection of all subjects
...
//   return (
//     <div 
//       className="flex flex-col md:px-4 lg:px-8 xl:px-20 min-h-screen relative"
//       style={{
//         background: "linear-gradient(80deg, rgba(19, 77, 88, 1) 32%, rgba(30, 109, 125, 1) 61%, rgba(41, 113, 127, 1) 65%)"
//       }}
//     >
//       <div className="flex justify-center items-center mt-4 mb-16 space-x-4">
//         {(["stranded", "premium"] as const).map((type) => (
...
//             className={`px-4 py-2 rounded-lg font-medium text-sm transition-colors ${
//               planType === type
//                 ? "bg-[#1E6D7D] text-white"
//                 : "bg-[#134D58] text-gray-300 hover:bg-[#1E6D7D]"
//             }`}
//           >
//             {type === "stranded" ? "Ad Free" : "Premium Model"}
//           </button>
...
//               <div className="bg-[#1E6D7D] rounded-lg p-6 border border-[#296F7F]">
//                 <div className="flex justify-between items-center mb-6">
//                   <h3 className="text-lg font-semibold text-white">
//                     Choose Your Subjects
//                   </h3>
...
//                   >
//                     <span className="text-white text-sm mr-2">Select All</span>
//                     <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${selectAll ? 'bg-[#296F7F] border-[#296F7F]' : 'border-gray-300'}`}>
//                       {selectAll && (
//                         <svg className="w-3 h-3 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
//                           <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" d="M5 13l4 4L19 7" />
//                         </svg>
...
//                   className={`px-8 py-3 rounded-lg font-bold text-lg transition-colors ${
//                     selectedSubjects.length === 0
//                       ? "bg-[#296F7F] cursor-not-allowed"
//                       : "bg-[#296F7F] hover:bg-[#1E6D7D] text-white"
//                   }`}
//                 >
//                   {selectedSubjects.length > 0 && selectedPlan
//                     ? `Continue to Checkout (${
...
//             <div className="relative w-full md:w-2/3 lg:w-1/2 xl:w-2/5 h-full bg-[#1E6D7D] overflow-hidden border-l border-[#296F7F]">
//               <div className="h-full flex flex-col">
//                 <button
//                   onClick={handleCloseCheckout}
...
//         <div className="mb-4 md:mb-6">
//           <h3 className="text-base md:text-lg font-medium mb-2 md:mb-3 text-white">Plan</h3>
//           <div className="rounded-lg p-3 md:p-4 bg-[#134D58] border border-[#296F7F]">
//             <div className="flex justify-between items-center">
//               <span className="text-white font-medium">{plan.name}</span>
//               <span className="text-white">
//                 {plan.currency} {plan.price}
...
//               <div
//                 key={index}
//                 className="flex justify-between items-center rounded-lg p-2 md:p-3 bg-[#134D58] border border-[#296F7F]"
//               >
//                 <span className="text-white text-sm md:text-base">{subject}</span>
//                 <span className="text-white text-sm md:text-base">
//                   {plan.currency} {subjectPrices[subject]}
...
//         <div className="border-t border-[#296F7F] pt-3 md:pt-4 mt-auto">
//           <div className="flex justify-between items-center">
//             <span className="text-base md:text-lg font-semibold text-white">Total</span>
//             <span className="text-base md:text-lg font-bold text-white">
//               {plan.currency} {totalPrice}
...
//         <button className="w-full bg-[#296F7F] hover:bg-[#1E6D7D] text-white font-bold py-2 md:py-3 px-4 rounded-lg mt-4 md:mt-6 transition-colors">
//           Complete Purchase
//         </button>
//       </div>
//     );
...
//           ${isSelected ? 'bg-[#296F7F]/30 border-[#296F7F]' : 'bg-[#134D58] border-[#296F7F]'} 
//           ${isHovered ? 'border-[#1E6D7D]' : ''}`}
//         onClick={onClick}
//         onMouseEnter={onHover}
//         onMouseLeave={onLeave}
//       >
//         {/* Circular Checkbox */}
//         <div className="absolute top-3 right-3">
//           <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${isSelected ? 'bg-[#296F7F] border-[#296F7F]' : 'border-gray-300'}`}>
//             {isSelected && (
//               <svg className="w-3 h-3 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
//                 <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" d="M5 13l4 4L19 7" />
//               </svg>
