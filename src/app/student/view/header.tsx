          ...
          <div className={`absolute bottom-0 left-0 right-0 rounded-t-lg p-4 ${
            ...
            <div className="flex items-center mb-4">
              <div className="h-12 w-12 rounded-full bg-blue-500 flex items-center justify-center mr-3">
                <span className={`font-medium text-lg ${isDarkMode ? "text-white" : "text-gray-800"}`}>
                  {user?.name?.charAt(0) || "L"}
                </span>
              </div>
              <div>
                <p className={`font-medium ${isDarkMode ? "text-white" : "text-gray-800"}`}>{user?.name}</p>
            ...
            <div className="space-y-2">
              <Link
                ...
                className={`block w-full text-left px-4 py-3 rounded-lg ${
                  isDarkMode ? "bg-[#65c7f7]" : "bg-gray-100"
                }`}
                onClick={() => setShowMobileProfilePopup(false)}
              >
                Your Profile
